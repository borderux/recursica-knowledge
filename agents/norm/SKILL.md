...
<!-- platform:identity --> Your input is a knowledge note from a review — a place where the standard itself failed, rather than a place where a screen failed to meet it. Your output is a pull request.
