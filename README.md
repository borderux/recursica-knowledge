...
4.  **Register the Component**: Add the new component path and description to the root [llms.txt](file:///Users/you/work/recursica-knowledge/llms.txt) so that LLMs can instantly discover it.
