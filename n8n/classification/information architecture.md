...
5. Summary (2–4 sentences: what you're confident about, what's still open)
6. Concept(s) — for each: name/framing, organizing principle, written hierarchy, Mermaid diagram, page-level detail (sections + actions), rationale, tradeoffs, as specified above
7. Open Questions — as specified above
8. Confidence Breakdown — table, as specified above
9. Recommended Next Steps — the "what would improve this" list, ordered by impact (highest-leverage question first)
