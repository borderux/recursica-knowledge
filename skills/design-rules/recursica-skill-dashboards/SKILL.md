...
**The prohibition on inner scrolling is not a dashboard rule — it applies to the whole application.** One scrollbar, sticky regions that stay put, and no region the user must hover to scroll. See `recursica-skill-screen-priority`.
